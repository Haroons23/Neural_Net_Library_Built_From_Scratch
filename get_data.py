...
def run_neural_network():
    ...
    #hidden_layer_structure = [[9],[10],[15],[4],[5],[6],[7],[8],[11], [12]]
    #learning_rate = 0.02
    #config = 2
    ...
    for test_fold in range(0, len(data_input)):
        ...
        for validation_fold in fold_indexes:
            ...
            # Training.
            neural_nets[0].train(combined_folds_input, combined_folds_label, 0.01, 0, 0) # Last index is for validation. 
        ...
        #print("Lowest: " + str(lowest_error_index))
    ...
    '''
        ...
        n = NeuralNetwork(7, hidden_layer_structure[config], 2)
        ...
        for test_case in range(0, len(data_input[test_fold])):
            ...
            if temp_output[0] > temp_output[1]:
                final_output = 0
            elif temp_output[1] > temp_output[0]:
                final_output = 1
            else:
                print("equal outputs!")

            if (data_labels[test_fold][test_case][0] == 1 and final_output == 0) or (data_labels[test_fold][test_case][1] == 1 and final_output == 1):
                correct += 1
            else:
                wrong += 1
...
def read_training_data():
    ...
    # Output for EMG: Zero means healthy, One means Myogenic, Two means Neurogenic.
